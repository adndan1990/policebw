...
// 3. INITIALISATION UNIQUE DE FIREBASE
...
async function EnregistrerOuVerifierAgent(agent) {
    ...
    if (agentSnap.exists()) {
        ...
        // Crée automatiquement si l'agent fait une action sans s'être inscrit avant
